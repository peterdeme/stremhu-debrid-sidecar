...
OUTCOME_LABELS = {
    ...
    Outcome.NO_RESOLUTION: "nincs felbontás a névben",
    Outcome.NO_LANGUAGE_TAG: "nincs nyelvjelölés a névben",
...
OUTCOME_SENTENCES = {
    ...
    Outcome.NO_RESOLUTION: "nincs felbontás a névben, nem került feltöltésre",
    Outcome.NO_LANGUAGE_TAG: "nincs nyelvjelölés a névben, nem került feltöltésre",
